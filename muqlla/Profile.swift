    ...
    var body: some View {
                    ...
                    VStack(spacing: 15) {
                        ForEach(viewModel.novels) { novel in
                            NovelRowView(
                                ...
                                deleteAction: {
                                    viewModel.deleteBook(novel.id) // Use id for deletion
                                }
                            )
                        }
                    }
        ...
        .preferredColorScheme(.dark)
                ...
                struct TopTabsView: View {
                    ...
                    var body: some View {
                        HStack(spacing: 12) {
                            TabButton(title: "Drafts", isSelected: selectedTab == 0, selectedColor: .green, defaultBackground: Image("darkgray"))
                                .onTapGesture { selectedTab = 0 }
                            
                            TabButton(title: "Collabs", isSelected: selectedTab == 1, selectedColor: .green, defaultBackground: Image("darkgray"))
                                .onTapGesture { selectedTab = 1 }
                            
                            TabButton(title: "Publish", isSelected: selectedTab == 2, selectedColor: .green, defaultBackground: Image("darkgray"))
